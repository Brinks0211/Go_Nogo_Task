...
function introduction4RoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of introduction4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function loop_light1LoopBegin(thisScheduler) {
  ...
  for (const thisLoop_light1 of loop_light1) {
...
function loop_face1LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisLoop_face1 of loop_face1) {
...
function loop_light2LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisLoop_light2 of loop_light2) {
...
function loop_face2LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisLoop_face2 of loop_face2) {
...
function lightRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of lightComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function faceRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of faceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function tip1RoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of tip1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function tip2RoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of tip2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
